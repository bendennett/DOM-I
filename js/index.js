...
middlehead[1].textContent = "ABOUT";
middlehead[2].textContent = "SERVICES";
middlehead[3].textContent = "PRODUCT";
middlehead[4].textContent = "VISION";
middlehead[5].textContent = "CONTACT";
...
bodytext[5].textContent = "123 Way 456 Street Somewhere, USA";
